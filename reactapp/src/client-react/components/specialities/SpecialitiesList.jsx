        ...
        <table className="table mb-0">
            <thead>
                <tr>
                    ...
                    <th className="text-center" width="120">
                        <button type="button" className="btn text-success ms-2 p-0" onClick={onClickCreateSpeciality} >
            ...
            <tbody>{
                specialities.map((item) =>
                    <Speciality key={item.code + item.directionName ?? item.fullName} speciality={item} onClickEdit={onClickEditSpeciality} onClickDelete={onClickDeleteSpeciality} />
                )}
            </tbody>
        </table>
    </div>;
