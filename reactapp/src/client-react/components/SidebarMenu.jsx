    ...
    return (
        <div className="position-sticky">
            <div className="list-group list-group-flush mx-3 mt-3">
                <Link to="/" id="Home" className="list-group-item list-group-item-action py-2 ripple" aria-current="true">
                ...
                <Link to="/Faculties" id="Faculties" className="list-group-item list-group-item-action py-2 ripple">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="fas fa-chart-pie fa-fw me-2" viewBox="0 0 16 16">
                        <path d="m8 0 6.61 3h.89a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-.5.5H15v7a.5.5 0 0 1 .485.38l.5 2a.498.498 0 0 1-.485.62H.5a.498.498 0 0 1-.485-.62l.5-2A.501.501 0 0 1 1 13V6H.5a.5.5 0 0 1-.5-.5v-2A.5.5 0 0 1 .5 3h.89L8 0ZM3.777 3h8.447L8 1 3.777 3ZM2 6v7h1V6H2Zm2 0v7h2.5V6H4Zm3.5 0v7h1V6h-1Zm2 0v7H12V6H9.5ZM13 6v7h1V6h-1Zm2-1V4H1v1h14Zm-.39 9H1.39l-.25 1h13.72l-.25-1Z" />
                    </svg>
                    <span>Факультеты</span>
                </Link>
                <Link to="/RecruitmentPlans" id="RecruitmentPlans" className="list-group-item list-group-item-action py-2 ripple">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="fas fa-chart-pie fa-fw me-2" viewBox="0 0 16 16">
                ...
                <Link to="/Students" id="Students" className="list-group-item list-group-item-action py-2 ripple">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="fas fa-chart-pie fa-fw me-2" viewBox="0 0 16 16">
                        <path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7Zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm-5.784 6A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216ZM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z" />
                    </svg>
                    <span>Студенты</span>
                </Link>
                <Link to="/Subjects" id="Subjects" className="list-group-item list-group-item-action py-2 ripple">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="fas fa-chart-pie fa-fw me-2" viewBox="0 0 16 16">
                ...
                <Link to="#" id="Users" className="list-group-item list-group-item-action py-2 ripple">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="fas fa-chart-pie fa-fw me-2" viewBox="0 0 16 16">
                ...
                <Link to="/Archive" id="Archive" className="list-group-item list-group-item-action py-2 ripple">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="fas fa-chart-pie fa-fw me-2" viewBox="0 0 16 16">
